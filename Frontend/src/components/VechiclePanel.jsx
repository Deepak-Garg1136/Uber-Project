    ...
    <>
      ...
      <div className="flex flex-col gap-5">
        ...
        >
          ...
          <h2 className="text-[#3FC3EE] font-bold text-lg">₹{fare.car}</h2>
        </div>
        ...
        >
          ...
          <h2 className="text-[#3FC3EE] font-bold text-lg">₹{fare.moto}</h2>
        </div>
        ...
        >
          ...
          <h2 className="text-[#3FC3EE] font-bold text-lg">₹{fare.auto}</h2>
        </div>
      </div>
    </>
  );
